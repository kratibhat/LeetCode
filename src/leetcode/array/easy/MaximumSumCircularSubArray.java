...
// nums at most once. Formally, for a subarray nums[i], nums[i + 1], ..., nums[j],
...
public class MaximumSumCircularSubArray {
    public int maxSubarraySumCircular(int[] nums) {
        ...
        int minSum = nums[0];
        int currentMin = 0;
// 5, -3, 5--> 5 and 5 r wrapping coz of circular so we minus min subaarray which is the middle part

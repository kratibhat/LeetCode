package leetcode.dp.easy.MCPDP;
...
public class MinimumCosttoCutaStick {
    public int minCost(int n, int[] cuts) {
        int m = cuts.length;
        // 1. Create a new array including the boundaries 0 and n
        ...
        // 4. Iterate through lengths of intervals
        ...
        // The answer for the full stick from index 0 to m+1
        return dp[0][m + 1];
    }
